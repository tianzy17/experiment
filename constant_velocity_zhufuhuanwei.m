...
for i=1:1:n
    ...
    PositionAxle6(i,:)=[data.rtk1_lon(5*i-4)-data.rtk1_lon(1) data.rtk1_lat(5*i-4)-data.rtk1_lat(1)];
    PositionAxle4(i,:)=[data.rtk2_lon(5*i-4)-data.rtk1_lon(1) data.rtk2_lat(5*i-4)-data.rtk1_lat(1)];
    PositionAxle2(i,:)=[data.rtk3_lon(5*i-4)-data.rtk1_lon(1) data.rtk3_lat(5*i-4)-data.rtk1_lat(1)];
    Azimuth3(i)=data.rtk1_timestamp(5*i-4)/180*pi;
    Azimuth2(i)=data.rtk2_timestamp(5*i-4)/180*pi;
    Azimuth1(i)=data.rtk3_timestamp(5*i-4)/180*pi;
    % Azimuth3(i)=Azimuth3_Ini(5*i-4)/180*pi;
    % Azimuth2(i)=Azimuth2_Ini(5*i-4)/180*pi;
    % Azimuth1(i)=Azimuth1_Ini(5*i-4)/180*pi;
    PositionAxle1(i,:)=[PositionAxle2(i,1)+(a1+b1)*cos(Azimuth1(i)) PositionAxle2(i,2)+(a1+b1)*sin(Azimuth1(i))];
    PositionJoint12_Mc1(i,:)=[PositionAxle2(i,1)-(c1-b1)*cos(Azimuth1(i)) PositionAxle2(i,2)-(c1-b1)*sin(Azimuth1(i))];
    PositionAxle3(i,:)=[PositionAxle4(i,1)+(a2+b2)*cos(Azimuth2(i)) PositionAxle4(i,2)+(a2+b2)*sin(Azimuth2(i))];
    PositionJoint12_T(i,:)=[PositionAxle4(i,1)+(d2+b2)*cos(Azimuth2(i)) PositionAxle4(i,2)+(d2+b2)*sin(Azimuth2(i))];
    PositionJoint23_T(i,:)=[PositionAxle4(i,1)-(c2-b2)*cos(Azimuth2(i)) PositionAxle4(i,2)-(c2-b2)*sin(Azimuth2(i))];
    PositionAxle5(i,:)=[PositionAxle6(i,1)+(a3+b3)*cos(Azimuth3(i)) PositionAxle6(i,2)+(a3+b3)*sin(Azimuth3(i))];
    PositionJoint23_Mc2(i,:)=[PositionAxle6(i,1)+(d3+b3)*cos(Azimuth3(i)) PositionAxle6(i,2)+(d3+b3)*sin(Azimuth3(i))];
