...
for i=1:1:n
    ...
    PositionAxle5(i,:)=[data.rtk3_lon(5*i-4)-data.rtk1_lon(1) data.rtk3_lat(5*i-4)-data.rtk1_lat(1)];
    Azimuth1(i)=data.rtk1_timestamp(5*i-4)/180*pi;
    Azimuth2(i)=data.rtk2_timestamp(5*i-4)/180*pi;
    Azimuth3(i)=data.rtk3_timestamp(5*i-4)/180*pi;
