...
for i=1:1:n
    ...
    Azimuth2(i)=(data.rtk2_timestamp(5*i-4)+100)/180*pi;
    ...
    PositionJoint12_Mc1(i,:)=[PositionAxle2(i,1)+(a1+c1)*cos(Azimuth1(i)) PositionAxle2(i,2)+(a1+c1)*sin(Azimuth1(i))];
...
for i=1:floor(n/10):n
    plot(PositionJoint12_Mc1(i,1),PositionJoint12_Mc1(i,2),'o')
